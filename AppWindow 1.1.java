...
//    package test2102;
	 ...
	 */
	public class AppWindow extends AbstractApplication {
...
//	            DefaultDrawingEditor editor = getEditor(p);
//	            ToolBarButtonFactory.addToolTo(tb, p, new CreationTool(new Rectangle(), attributeMap), "Create Rectangle" , labels);
	            id++;
	            JPanel panel = new JPanel(new BorderLayout());
	            panel.add(tb, BorderLayout.NORTH);
	            panel.add(c, BorderLayout.CENTER);
	    ...
	    protected JMenuBar createMenuBar(final Project p, java.util.List<Action> toolBarActions) {
	       ...
	       ResourceBundleUtil labels = ResourceBundleUtil.getLAFBundle("org.jhotdraw.app.Labels");
	        ...
	        //Put a "New" function in the "File" menu which creates a new window
	    ...
	    private void updateOpenRecentMenu(JMenu openRecentMenu) {
	        if (openRecentMenu.getItemCount() > 0) {
	            ...
	            for (File f : recentFiles()) {
	                openRecentMenu.add(new LoadRecentAction(AppWindow.this, f));
	            }
